...
def swap_color_defaults(night: bool):
    if night:   # night colors for matrix
        utils.time_color = graphics.Color(160, 0, 0)
        utils.date_color = graphics.Color(128, 0, 0)
        utils.weather_color = graphics.Color(128, 0, 0)
        utils.text_color = graphics.Color(128, 0, 0)
    else:       # day time colors for the matrix
        utils.time_color = graphics.Color(255, 0, 0)
        utils.date_color = graphics.Color(156, 0, 156)
        utils.weather_color = graphics.Color(0, 64, 255)
